...
if [ "$1" = "--help" ] || [ "$1" = "-h" ]; then
    ...
    echo ""
    echo "Usage:"
    echo "  curl -sSL https://raw.githubusercontent.com/yarlson/gic/main/install.sh | bash"
    echo "  curl -sSL https://raw.githubusercontent.com/yarlson/gic/main/install.sh | bash -s v0.0.1"
    echo "  gic_VERSION=v0.0.1 curl -sSL https://raw.githubusercontent.com/yarlson/gic/main/install.sh | bash"
    echo ""
